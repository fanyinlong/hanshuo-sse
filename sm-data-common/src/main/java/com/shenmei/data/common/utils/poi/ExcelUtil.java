package com.shenmei.data.common.utils.poi;

import com.shenmei.data.common.annotation.Excel;
import com.shenmei.data.common.annotation.Excel.ColumnType;
import com.shenmei.data.common.annotation.Excel.Type;
import com.shenmei.data.common.annotation.Excels;
import com.shenmei.data.common.config.RuoYiConfig;
import com.shenmei.data.common.core.domain.AjaxResult;
import com.shenmei.data.common.core.text.Convert;
import com.shenmei.data.common.exception.UtilException;
import com.shenmei.data.common.utils.DateUtils;
import com.shenmei.data.common.utils.DictUtils;
import com.shenmei.data.common.utils.StringUtils;
import com.shenmei.data.common.utils.file.FileTypeUtils;
import com.shenmei.data.common.utils.file.FileUtils;
import com.shenmei.data.common.utils.file.ImageUtils;
import com.shenmei.data.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T> {
    ...
    public void exportExcel(HttpServletResponse response) {
        ...
        try {
            ...
            log.info("导出Excel成功，耗时: {}ms", (endTime - startTime));
        } catch (Exception e) {
            long endTime = System.currentTimeMillis();
            log.error("导出Excel异常{}，耗时: {}ms", e.getMessage(), (endTime - startTime));
