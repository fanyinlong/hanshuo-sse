...
/**
 * 规则配置对象 sse_data_rule
 * 
 * @author teabot
 * @date 2025-07-20
 */
public class SseDataRule extends BaseEntity
{
    ...
    /** 订阅PBU总量 */
    @Excel(name = "订阅PBU总量")
    private Long subscribePbuCount;

    /** 全市场被订阅pbu数量 */
    @Excel(name = "全市场被订阅pbu数量")
    private Long totalSubscribedPbuCount;
    ...
    /** 订阅执行报告占比 */
    @Excel(name = "订阅执行报告占比")
    private BigDecimal subscribeReportRatio;
    ...
    public void setLoginPbu(Long loginPbu)
    {
        this.loginPbu = loginPbu;
    }

    public Long getLoginPbu()
    {
        return loginPbu;
    }
    ...
    public Long getSubscribePbuCount() {
        return subscribePbuCount;
    }

    public void setSubscribePbuCount(Long subscribePbuCount) {
        this.subscribePbuCount = subscribePbuCount;
    }

    public Long getTotalSubscribedPbuCount() {
        return totalSubscribedPbuCount;
    }

    public void setTotalSubscribedPbuCount(Long totalSubscribedPbuCount) {
        this.totalSubscribedPbuCount = totalSubscribedPbuCount;
    }
    ...
    public String getOneToManyList() {
        return oneToManyList;
    }

    public void setOneToManyList(String oneToManyList) {
    ...
    public BigDecimal getSubscribeReportRatio() {
        return subscribeReportRatio;
    }

    public void setSubscribeReportRatio(BigDecimal subscribeReportRatio) {
        this.subscribeReportRatio = subscribeReportRatio;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
                ...
                .append("subscribePbuCount", getSubscribePbuCount())
                .append("totalSubscribedPbuCount", getTotalSubscribedPbuCount())
                .append("totalAccountCount", getTotalAccountCount())
                .append("oneToManyList", getOneToManyList())
                .append("orderCount", getOrderCount())
                .append("subscribeReportRatio", getSubscribeReportRatio())
                .toString();
    }
}
